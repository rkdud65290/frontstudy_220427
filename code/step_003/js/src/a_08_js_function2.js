...
//-----------------------
// 함수표현식, 익명함수:권장
// 호이스팅문데 해결, 함수이름 중복 방지
// 함수를 먼저 생성 후 이를 호출하기 때문에 원인/근거, 활용에 대한 순서를 파악하기 쉽다.
...
// 외부에 함수내부 자료를 노출시키는 것을 막기위해...

const Fn3=function(){ return '던질값이 없어도 동작할 수 있다';}
console.log(Fn3());
...
let obj={};
let obj2= new Object; //기본 의 객체형식을 새로 생성해서 사용
...
//this: 아무것도 호출하지 않았을때는 window
//this: 생성자 함수를 이용하여 처리할 경우 해당하는 변수명
//----------------------------------------------------
...
//전송버튼에 이벤트 발행(클릭 후 데이터의 값을 체크)
sendBtn.addEventListener('click', function(e){
  e.preventDefault(); //선행되는 이벤트 기능을 막기
